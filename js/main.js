var url="//overpass-api.de/api/interpreter?";
//var url="//overpass.osm.rambler.ru/cgi/interpreter?";
var n=false;
var datan=new Date();
...
function showNoteMessage(header,body,callback,lon,lat){
  ...
  console.log(lon+" :" +lat);
  $.ajax({
    url: "//api.openstreetmap.org/api/0.6/notes.json",
...
var nominatimQuery = function (){
  var url = '//nominatim.openstreetmap.org/reverse';
...
var zoomControl = L.control.zoom({
  ...
  var attrib = 'ODbL OpenStreetMap, Data: <a href="//www.overpass-api.de/">OverpassAPI</a>';
  var osm = new L.TileLayer('//{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {maxZoom: 19, subdomains: 'abc', attribution: attrib,   detectRetina: true});
